...
class analyticsdashboard2 extends Component {
  ...
  constructor(props){
    ...
    data5 : [
     ...
     data3 : [
      {
        name: date31,  NumberOfCVs: 10, 
      },
      {
        name: date30,  NumberOfCVs: 10, 
      },
      {
        name: date29, NumberOfCVs: 10, 
      },
      {
        name: date28,  NumberOfCVs: 10, 
      },
      {
        name: date27, NumberOfCVs: 10, 
      },
      {
        name: date26,  NumberOfCVs: 10, 
      },
      {
        name: date25,  NumberOfCVs: 10,
      },
      {
        name: date24,  NumberOfCVs: 10, 
      },
      {
        name: date23,  NumberOfCVs: 10, 
      },
      {
        name: date22, NumberOfCVs: 10,
      },
      {
        name: date21,  NumberOfCVs: 10, 
      },
      {
        name: date20, NumberOfCVs: 10, 
      },
      {
        name: date19,  NumberOfCVs: 10, 
      },
      {
        name: date18,  NumberOfCVs: 10,
      },
      {
        name: date17,  NumberOfCVs: 10, 
      },
      {
        name: date16,  NumberOfCVs: 10, 
      },
      {
        name: date15, NumberOfCVs: 10, 
      },
      {
        name: date14,  NumberOfCVs: 10, 
      },
      {
        name: date13, NumberOfCVs: 10, 
      },
      {
        name: date12,  NumberOfCVs: 10, 
      },
      {
        name: date11,  NumberOfCVs: 10,
      },
      {
        name: date10,  NumberOfCVs: 10, 
      },
      {
        name: date9,  NumberOfCVs: 10, 
      },
      {
        name: date8, NumberOfCVs: 10, 
      },
      {
...
//////////////////////////////////////////////////////////////////////////////////////////
  submitesearchbydate = () => {
    if (this.state.date.from && this.state.date.to) { 
      ...
      console.log("hii"+this.state.date);
  ...
  render() {
    return (
      ...
      >
        ...
        <XAxis dataKey="name" label={{ value: 'Date', position: 'insideBottomRight', offset: -20 }} /> 
        <YAxis label={{ value: 'No Of CVs Received' , angle: -90, position: 'insideBottomLeft' }} />
        <Tooltip />
        <Legend />
...
<Card style={pie} className={pie}>
    ...
    <Typography variant ="h6" component="h2" >
        ...
        >
          {
            this.state.data4.map((entry, index) => <Cell key={'cell-${index}'} fill={COLORS[index % COLORS.length]} />)
          }
...
<Card style={pie} className={pie}>
    ...
    <Typography variant ="h6" component="h2" >
        ...
        >
          {
            this.state.data5.map((entry, index) => <Cell key={'cell-${index}'} fill={COLORS[index % COLORS.length]} />)
          }
